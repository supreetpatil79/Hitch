...
// ── Pure Minimalist Scroll-reveal Tagline ───────────────────────────────────
function ScrollTagline() {
  ...
  return (
    <div
      ref={ref}
      className="py-24 sm:py-32 lg:py-36 flex flex-col items-center justify-center text-center select-none overflow-hidden"
      aria-label="Rail. Road. Runway. Delivered."
    >
      {/* Single-line pure italic serif */}
      <div className="overflow-hidden py-2 px-4 w-full">
        <h2
          className={
            "font-display italic leading-none " +
            "text-[9.2vw] sm:text-[7.8vw] lg:text-[6.6vw] xl:text-[5.8vw] tracking-tight " +
            "whitespace-nowrap transition-all duration-1000 ease-[cubic-bezier(0.16,1,0.3,1)] " +
            (visible
              ? "opacity-100 translate-y-0"
              : "opacity-0 translate-y-16")
          }
        >
          <span className="text-zinc-900 transition-colors duration-300 hover:text-hitchOrange">Rail. </span>
          <span className="text-hitchOrange">Road. </span>
          <span className="text-zinc-900 transition-colors duration-300 hover:text-hitchOrange">Runway. </span>
          <span className="text-hitchOrange">Delivered.</span>
        </h2>
      </div>

      {/* Understated hairline + minimalist metadata */}
      <div
        className={
          "mt-6 sm:mt-8 flex flex-wrap items-center justify-center gap-3 sm:gap-6 text-xs text-zinc-400 tracking-widest uppercase transition-all duration-1000 ease-out " +
          (visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6")
        }
        style={{ transitionDelay: "200ms" }}
      >
        <span className="font-mono text-[10px] sm:text-xs">173 Intercity Corridors</span>
        <span className="w-1 h-1 rounded-full bg-zinc-300" />
        <span className="font-mono text-[10px] sm:text-xs">Verified Commuter Network</span>
        <span className="w-1 h-1 rounded-full bg-zinc-300" />
        <span className="font-mono text-[10px] sm:text-xs">Zero-Trust Escrow</span>
      </div>
    </div>
  );
}
          ...
          <div className="border-4 border-black p-6 bg-white space-y-5 rounded-lg shadow-xs">
            ...
            <div className="grid grid-cols-2 gap-4 border-b-2 border-black pb-4 text-xs">
              ...
              <div className="space-y-1">
                ...
                <p className="font-bold text-sm">Authenticated Consignee</p>
                <p className="text-emerald-700 font-mono text-[11px] font-semibold">Dual-OTP Escrow Verified</p>
                ...
                <div>
                  ...
                  <div className="my-3">
                    ...
                    <p className="text-[11px] text-zinc-400 mt-1 flex items-center justify-between font-medium">
                      <span>Direct Corridor · Verified Commuter</span>
